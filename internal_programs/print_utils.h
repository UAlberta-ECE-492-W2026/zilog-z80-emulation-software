...
volatile char * software_keyboard_write_address_ptr = (char *) (0xFFF3); 
volatile char * software_keyboard_read_address_ptr = (char *) (0xFFF4); 
...
int write_to_software_terminal(char c) {
   *software_keyboard_write_address_ptr = c;
}
